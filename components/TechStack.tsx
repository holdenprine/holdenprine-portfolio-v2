    ...
    {Object.entries(techCatagories).map(([category, items], index) => (
      ...
      >
        <motion.div
          ...
          className="cursor-pointer text-lg font-semibold bg-[var(--foreground)] text-[var(--text-color)] px-6 py-3 rounded-lg shadow-md 
        ...
        {openCategory === category && (
          <motion.div
            className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 bg-gray-200 text-black p-6 rounded-xl shadow-xl transition-opacity duration-300 min-w-[200px]"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          >
